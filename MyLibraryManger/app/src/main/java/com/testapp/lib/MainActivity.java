...
public class MainActivity extends AppCompatActivity {
    ...
    private void addFirstRecs() {
        ...
        dbHandler.addMembers("V.Kirushnakishore",formattedTimestamp);
        dbHandler.addMembers("M.Thajaparan",formattedTimestamp);
        dbHandler.addMembers("P.Kamsapriya",formattedTimestamp);
        dbHandler.addMembers("S.Gajane",formattedTimestamp);
        dbHandler.addMembers("J.Sampabi",formattedTimestamp);
    }
